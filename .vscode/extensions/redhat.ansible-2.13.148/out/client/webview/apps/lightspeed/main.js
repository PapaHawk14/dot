...
`});class vo extends uo{}const yo=vo.compose({baseName:"data-grid-row",baseClass:uo,template:(e,t)=>{const i=function(e){const t=e.tagFor(bo);return Ft`
    <${t}
...
`}),$o={horizontal:"horizontal",vertical:"vertical"},wo={separator:"separator",presentation:"presentation"};class ko extends Ae{constructor(){super(...arguments),this.role=wo.separator,this.orientation=$o.horizontal}}M([P],ko.prototype,"role",void 0),M([P],ko.prototype,"orientation",void 0);class Io extends ko{}const To=Io.compose({baseName:"divider",template:(e,t)=>Ft`
...
`,shadowOptions:{delegatesFocus:!0}});class Yo extends Ro{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Option")}}const Jo=Yo.compose({baseName:"option",template:(e,t)=>Ft`
    <template
...
`});class kn extends Ae{}class In extends(gs(kn)){constructor(){super(...arguments),this.proxy=document.createElement("input")}}const Tn={email:"email",password:"password",tel:"tel",text:"text",url:"url"};class On extends In{constructor(){super(...arguments),this.type=Tn.text}readOnlyChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.readOnly=this.readOnly,this.validate())}autofocusChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.autofocus=this.autofocus,this.validate())}placeholderChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.placeholder=this.placeholder)}typeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.type=this.type,this.validate())}listChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.setAttribute("list",this.list),this.validate())}maxlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.maxLength=this.maxlength,this.validate())}minlengthChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.minLength=this.minlength,this.validate())}patternChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.pattern=this.pattern,this.validate())}sizeChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.size=this.size)}spellcheckChanged(){this.proxy instanceof HTMLInputElement&&(this.proxy.spellcheck=this.spellcheck)}connectedCallback(){super.connectedCallback(),this.proxy.setAttribute("type",this.type),this.validate(),this.autofocus&&f.queueUpdate((()=>{this.focus()}))}select(){this.control.select(),this.$emit("select")}handleTextInput(){this.value=this.control.value}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([P({attribute:"readonly",mode:"boolean"})],On.prototype,"readOnly",void 0),M([P({mode:"boolean"})],On.prototype,"autofocus",void 0),M([P],On.prototype,"placeholder",void 0),M([P],On.prototype,"type",void 0),M([P],On.prototype,"list",void 0),M([P({converter:D})],On.prototype,"maxlength",void 0),M([P({converter:D})],On.prototype,"minlength",void 0),M([P],On.prototype,"pattern",void 0),M([P({converter:D})],On.prototype,"size",void 0),M([P({mode:"boolean"})],On.prototype,"spellcheck",void 0),M([v],On.prototype,"defaultSlottedNodes",void 0);class Sn{}Zi(Sn,Ki),Zi(On,Xi,Sn);class En extends Ae{}class Rn extends(gs(En)){constructor(){super(...arguments),this.proxy=document.createElement("textarea")}}const An={none:"none",both:"both",horizontal:"horizontal",vertical:"vertical"};class Dn extends Rn{constructor(){super(...arguments),this.resize=An.none,this.cols=20,this.handleTextInput=()=>{this.value=this.control.value}}readOnlyChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.readOnly=this.readOnly)}autofocusChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.autofocus=this.autofocus)}listChanged(){this.proxy instanceof HTMLTextAreaElement&&this.proxy.setAttribute("list",this.list)}maxlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.maxLength=this.maxlength)}minlengthChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.minLength=this.minlength)}spellcheckChanged(){this.proxy instanceof HTMLTextAreaElement&&(this.proxy.spellcheck=this.spellcheck)}select(){this.control.select(),this.$emit("select")}handleChange(){this.$emit("change")}validate(){super.validate(this.control)}}M([P({mode:"boolean"})],Dn.prototype,"readOnly",void 0),M([P],Dn.prototype,"resize",void 0),M([P({mode:"boolean"})],Dn.prototype,"autofocus",void 0),M([P({attribute:"form"})],Dn.prototype,"formId",void 0),M([P],Dn.prototype,"list",void 0),M([P({converter:D})],Dn.prototype,"maxlength",void 0),M([P({converter:D})],Dn.prototype,"minlength",void 0),M([P],Dn.prototype,"name",void 0),M([P],Dn.prototype,"placeholder",void 0),M([P({converter:D,mode:"fromView"})],Dn.prototype,"cols",void 0),M([P({converter:D,mode:"fromView"})],Dn.prototype,"rows",void 0),M([P({mode:"boolean"})],Dn.prototype,"spellcheck",void 0),M([v],Dn.prototype,"defaultSlottedNodes",void 0),Zi(Dn,Sn);class Bn extends Dn{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text area")}}const Pn=Bn.compose({baseName:"text-area",template:(e,t)=>Ft`
    <template
        class="
            ${e=>e.readOnly?"readonly":""}
            ${e=>e.resize!==An.none?`resize-${e.resize}`:""}"
    >
        <label
            part="label"
            for="control"
...
`,shadowOptions:{delegatesFocus:!0}});function Fn(e,t,i){return e.nodeType!==Node.TEXT_NODE||"string"==typeof e.nodeValue&&!!e.nodeValue.trim().length}class Ln extends On{connectedCallback(){super.connectedCallback(),this.textContent?this.setAttribute("aria-label",this.textContent):this.setAttribute("aria-label","Text field")}}const Hn=Ln.compose({baseName:"text-field",template:(e,t)=>Ft`
    <template
        class="
            ${e=>e.readOnly?"readonly":""}
        "
    >
        ...
        >
            <slot
                ${Is({property:"defaultSlottedNodes",filter:Fn})}
            ></slot>
        </label>
